...
.product-card {
  width: 18%; /* Reduced width to make cards smaller */
  background: #f9f9f9;
...
.product-name {
  ...
  display: block; /* Ensure the text block takes up space */
  width: 100%; /* Ensure the product name takes up the full width of its container */
}
