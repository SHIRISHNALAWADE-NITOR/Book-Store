      ...
      <div class="signup-content">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="form-group">
            ...
            <input type="password" id="confirm-password" class="form-control" v-model="formData.confirmPassword"
              required />
          </div>
    ...
    <div class="signup-content">
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="form-group">
          ...
          <input type="text" id="email" class="form-control" v-model="formData.email" required />
        </div>
        <div class="form-group">
          <label for="password">Password</label>
          <input type="password" id="password" class="form-control" v-model="formData.password" required />
  ...
  methods: {
    async submitForm() {
      ...
      const requestPayload = {
        ...
        email: `${this.formData.username}@example.com`, // default or use an actual email field if you add one
        passwordHash: this.formData.password // Adjust this if your backend expects a hashed password
      };
  ...
  methods: {
    async submitForm() {
      ...
      const requestPayload = {
        ...
        dateOfBirth: this.formData.dateOfBirth,
        phoneNumber: this.formData.phoneNumber,
        email: this.formData.email, // Use the actual email field
